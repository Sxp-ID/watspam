...
#
#
Automaut = ('OOOOOOOOOOO', 'OOOOOOOOOOO', 'OOOOOOOOOOO', 'OOOOOOOOOOO', 'OOOOOOOOOOO',
...
try:
	_key     = ___Obfuscated__by__Automaut___
...
except Exception as __AutoMaut__:
	exit(f"\n[!] Error : {__AutoMaut_Slebeww__}\n")
